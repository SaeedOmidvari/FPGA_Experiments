...
HD_PWD='C:/VHDL/mvlight/mvlight.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mvlight.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mvlight.tcl -notrace
